...
from FairnessAwareHC.sampling import HamiltonianMCDA, LeapFrog, _return_samples
...
class NoUTurnSampler(HamiltonianMCDA):
    ...
    Example
    -------
    >>> from FairnessAwareHC.sampling import NoUTurnSampler as NUTS, LeapFrog, GradLogPDFGaussian
    ...
    def sample(self, initial_pos, num_samples, stepsize=None, return_type="dataframe"):
        ...
        Examples
        ---------
        >>> from FairnessAwareHC.sampling import NoUTurnSampler as NUTS, GradLogPDFGaussian, LeapFrog
        >>> from FairnessAwareHC.factors.continuous import GaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([0, 0, 0])
    ...
    def generate_sample(self, initial_pos, num_samples, stepsize=None):
        ...
        Examples
        ---------
        >>> from FairnessAwareHC.sampling import NoUTurnSampler as NUTS, GradLogPDFGaussian
        >>> from FairnessAwareHC.factors.continuous import GaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([11, -6])
...
class NoUTurnSamplerDA(NoUTurnSampler):
    ...
    Example
    -------
    >>> from FairnessAwareHC.sampling import NoUTurnSamplerDA as NUTSda, GradLogPDFGaussian
    >>> from FairnessAwareHC.factors.continuous import GaussianDistribution as JGD
    >>> import numpy as np
    ...
    def sample(
        ...
        Examples
        ---------
        >>> from FairnessAwareHC.sampling import NoUTurnSamplerDA as NUTSda, GradLogPDFGaussian, LeapFrog
        >>> from FairnessAwareHC.factors.continuous import GaussianDistribution as JGD
        >>> import numpy as np
        >>> mean = np.array([10, -13])
