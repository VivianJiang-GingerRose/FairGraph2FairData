...
from FairnessAwareHC.factors import factor_product
from FairnessAwareHC.global_vars import SHOW_PROGRESS
from FairnessAwareHC.models import BayesianNetwork, MarkovChain, MarkovNetwork
from FairnessAwareHC.sampling import BayesianModelInference, _return_samples
from FairnessAwareHC.utils.mathext import sample_discrete, sample_discrete_maps
...
class BayesianModelSampling(BayesianModelInference):
    ...
    def rejection_sample(
        ...
        Parameters
        ----------
        evidence: list of `FairnessAwareHC.factor.State` namedtuples
            None if no evidence
...
class GibbsSampling(MarkovChain):
    ...
    >>> from FairnessAwareHC.sampling import GibbsSampling
    ...
    def sample(self, start_state=None, size=1, seed=None, include_latents=False):
        ...
        Examples
        --------
        >>> from FairnessAwareHC.factors.discrete import DiscreteFactor
        >>> from FairnessAwareHC.sampling import GibbsSampling
        >>> from FairnessAwareHC.models import MarkovNetwork
