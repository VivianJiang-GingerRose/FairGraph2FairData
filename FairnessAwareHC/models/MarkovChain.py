...
from FairnessAwareHC.utils import sample_discrete
...
class MarkovChain(object):
    ...
    >>> from FairnessAwareHC.models import MarkovChain as MC
    >>> model = MC()
    ...
    def prob_from_sample(self, state, sample=None, window_size=None):
        ...
        Examples
        --------
        >>> from FairnessAwareHC.models.MarkovChain import MarkovChain as MC
        >>> from FairnessAwareHC.factors.discrete import State
    ...
    def generate_sample(self, start_state=None, size=1, seed=None):
        ...
        Examples
        --------
        >>> from FairnessAwareHC.models.MarkovChain import MarkovChain
        >>> from FairnessAwareHC.factors.discrete import State
        >>> model = MarkovChain()
    ...
    def copy(self):
        ...
        Examples
        --------
        >>> from FairnessAwareHC.models import MarkovChain
        >>> from FairnessAwareHC.factors.discrete import State
        >>> model = MarkovChain()
        >>> model.add_variables_from(['intel', 'diff'], [3, 2])
        >>> intel_tm = {0: {0: 0.2, 1: 0.4, 2:0.4}, 1: {0: 0, 1: 0.5, 2: 0.5}, 2: {0: 0.3, 1: 0.3, 2: 0.4}}
