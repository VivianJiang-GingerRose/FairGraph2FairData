...
from FairnessAwareHC.factors.continuous import ContinuousFactor
from FairnessAwareHC.factors.discrete import (
    DiscreteFactor,
    JointProbabilityDistribution,
    TabularCPD,
)
from FairnessAwareHC.models.MarkovNetwork import MarkovNetwork
...
class BayesianNetwork(DAG):
    ...
    def add_cpds(self, *cpds):
        ...
        --------
        >>> from FairnessAwareHC.models import BayesianNetwork
        >>> from FairnessAwareHC.factors.discrete.CPD import TabularCPD
    ...
    def get_cpds(self, node=None):
        ...
        --------
        >>> from FairnessAwareHC.models import BayesianNetwork
        >>> from FairnessAwareHC.factors.discrete import TabularCPD
    ...
    def fit(
        ...
        **kwargs,
        ...
        >>> import pandas as pd
        >>> from FairnessAwareHC.models import BayesianNetwork
        >>> from FairnessAwareHC.estimators import MaximumLikelihoodEstimator
        ...
        """
        from FairnessAwareHC.estimators import BaseEstimator, MaximumLikelihoodEstimator
    ...
    def fit_update(self, data, n_prev_samples=None, n_jobs=-1):
        ...
        Examples
        --------
        >>> from FairnessAwareHC.utils import get_example_model
        ...
        """
        from FairnessAwareHC.estimators import BayesianEstimator
    ...
    def predict(self, data, stochastic=False, n_jobs=-1):
        ...
        999 0
        """
        from FairnessAwareHC.inference import VariableElimination
    ...
    def is_imap(self, JPD):
        ...
        >>> from FairnessAwareHC.models import BayesianNetwork
        >>> from FairnessAwareHC.factors.discrete import TabularCPD
        >>> from FairnessAwareHC.factors.discrete import JointProbabilityDistribution
        >>> G = BayesianNetwork([('diff', 'grade'), ('intel', 'grade')])
        >>> diff_cpd = TabularCPD('diff', 2, [[0.2], [0.8]])
        >>> intel_cpd = TabularCPD('intel', 3, [[0.5], [0.3], [0.2]])
        >>> grade_cpd = TabularCPD('grade', 3,
    ...
    def copy(self):
        ...
        Returns
        -------
        Model's copy: FairnessAwareHC.models.BayesianNetwork
    ...
    def get_random(n_nodes=5, edge_prob=0.5, n_states=None, latents=False):
        ...
        Returns
        -------
        Random DAG: FairnessAwareHC.base.DAG
    ...
    def do(self, nodes, inplace=False):
        ...
        Returns
        -------
        Modified network: FairnessAwareHC.models.BayesianNetwork or None
    ...
    def simulate(
        ...
        FairnessAwareHC.sampling.BayesianModelSampling to generate the data.
        ...
        virtual_evidence: list
            ...
            be a list of `FairnessAwareHC.factors.discrete.TabularCPD` objects specifying the
            virtual probabilities.

        virtual_intervention: list
            Also known as soft intervention. `virtual_intervention` should be a list
            of `FairnessAwareHC.factors.discrete.TabularCPD` objects specifying the virtual/soft
    ...
    def save(self, filename, filetype="bif"):
        ...
        if filetype == "bif":
            from FairnessAwareHC.readwrite import BIFWriter

            writer = BIFWriter(self)
            writer.write_bif(filename=filename)

        elif filetype == "uai":
            from FairnessAwareHC.readwrite import UAIWriter

            writer = UAIWriter(self)
            writer.write_uai(filename=filename)

        elif filetype == "xmlbif":
            from FairnessAwareHC.readwrite import XMLBIFWriter
    ...
    def load(filename, filetype="bif", **kwargs):
        ...
        if filetype == "bif":
            from FairnessAwareHC.readwrite import BIFReader
            ...
            from FairnessAwareHC.readwrite import UAIReader

            reader = UAIReader(path=filename)
            return reader.get_model()

        elif filetype == "xmlbif":
            from FairnessAwareHC.readwrite import XMLBIFReader
