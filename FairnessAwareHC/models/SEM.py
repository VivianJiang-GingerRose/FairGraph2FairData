...
from FairnessAwareHC.global_vars import HAS_PANDAS
...
class SEMGraph(DAG):
    ...
    def __init__(self, ebunch=[], latents=[], err_corr=[], err_var={}):
        ...
        >>> from FairnessAwareHC.models import SEMGraph
    ...
    def active_trail_nodes(self, variables, observed=[], avoid_nodes=[], struct="full"):
        ...
        Examples
        --------
        >>> from FairnessAwareHC.models import SEM
    ...
    def to_lisrel(self):
        ...
        representation which is implemented by `FairnessAwareHC.models.SEMAlg` class.
        ...
        from FairnessAwareHC.models import SEMAlg
    ...
    def to_standard_lisrel(self):
        ...
        See Also
        --------
        to_lisrel: Converts the model to `FairnessAwareHC.models.SEMAlg` instance.
...
class SEMAlg:
    ...
    def __init__(self, eta=None, B=None, zeta=None, wedge_y=None, fixed_values=None):
        ...
        Returns
        -------
        FairnessAwareHC.models.SEMAlg instance: An instance of the object with initalized values.
    ...
    def to_SEMGraph(self):
        ...
        Returns
        -------
        FairnessAwareHC.models.SEMGraph instance: A path model of the model.
...
class SEM(SEMGraph):
    ...
    def from_lisrel(cls, var_names, params, fixed_masks=None):
        ...
        Returns
        -------
        FairnessAwareHC.models.SEM instance: An instance of the object with initalized values.
    ...
    def from_RAM(
        ...
        Returns
        -------
        FairnessAwareHC.models.SEM instance: An instance of the object with initialized values.
