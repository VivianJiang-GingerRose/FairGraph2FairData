...
from pgmpyVJ.factors.distributions import GaussianDistribution, CustomDistribution
...
class ContinuousFactor(BaseFactor):
    ...
    def __init__(self, variables, pdf, *args, **kwargs):
        ...
        >>> from pgmpyVJ.factors.continuous import ContinuousFactor
    ...
    def discretize(self, method, *args, **kwargs):
        ...
        Parameters
        ----------
        method : A Discretizer Class from pgmpyVJ.discretize
