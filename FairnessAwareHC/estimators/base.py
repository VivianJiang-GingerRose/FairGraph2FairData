...
from FairnessAwareHC.utils.decorators import convert_args_tuple
...
class BaseEstimator(object):
    ...
    def state_counts(
        ...
        --------
        >>> import pandas as pd
        >>> from FairnessAwareHC.estimators import BaseEstimator
...
class ParameterEstimator(BaseEstimator):
    def __init__(self, model, data, **kwargs):
        """
        Base class for parameter estimators in FairnessAwareHC.

        Parameters
        ----------
        model: FairnessAwareHC.models.BayesianNetwork or FairnessAwareHC.models.MarkovNetwork or FairnessAwareHC.models.NoisyOrModel model
    ...
    def state_counts(self, variable, weighted=False, **kwargs):
        ...
        >>> from FairnessAwareHC.estimators import ParameterEstimator
...
class StructureEstimator(BaseEstimator):
    def __init__(self, data=None, independencies=None, **kwargs):
        """
        Base class for structure estimators in FairnessAwareHC.
