...
class MaximumLikelihoodEstimator(ParameterEstimator):
    def __init__(self, model, data, **kwargs):
        ...
        Parameters
        ----------
        model: A FairnessAwareHC.models.BayesianNetwork instance
    ...
    def get_parameters(self, n_jobs=-1, weighted=False):
        ...
        Estimated parameters: list
            List of FairnessAwareHC.factors.discrete.TabularCPDs, one for each variable of the model
    ...
    def estimate_cpd(self, node, weighted=False):
        ...
        Returns
        -------
        Estimated CPD: FairnessAwareHC.factors.discrete.TabularCPD
