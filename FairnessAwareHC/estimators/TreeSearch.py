...
from FairnessAwareHC.estimators import StructureEstimator
...
class TreeSearch(StructureEstimator):
    ...
    def _get_weights(
        ...
        FairnessAwareHC.estimators.TreeSearch for more details. This function returns the edge weights matrix.
    ...
    def _get_conditional_weights(
        ...
        FairnessAwareHC.estimators.TreeSearch for more details. This function returns the
        edge weights matrix.
    ...
    def _create_tree_and_dag(weights, columns, root_node):
        """
        Helper function to Chow-Liu algorithm for estimating tree structure from given data. Refer to
        FairnessAwareHC.estimators.TreeSearch for more details. This function returns the DAG based on the edge weights matrix.
        ...
        Returns
        -------
        model: FairnessAwareHC.base.DAG
            The estimated model structure.
