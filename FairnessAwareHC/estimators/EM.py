...
from FairnessAwareHC.estimators import MaximumLikelihoodEstimator, ParameterEstimator
...
class ExpectationMaximization(ParameterEstimator):
    def __init__(self, model, data, **kwargs):
        ...
        >>> import pandas as pd
        >>> from FairnessAwareHC.models import BayesianNetwork
        >>> from FairnessAwareHC.estimators import ExpectationMaximization
    ...
    def get_parameters(
        ...
        >>> import pandas as pd
        >>> from FairnessAwareHC.models import BayesianNetwork
        >>> from FairnessAwareHC.estimators import ExpectationMaximization as EM
