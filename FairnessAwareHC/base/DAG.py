...
from FairnessAwareHC.base import UndirectedGraph
from FairnessAwareHC.independencies import Independencies
...
class DAG(nx.DiGraph):
    ...
    **Shortcuts:**
    ...
    #         Returns
    #         -------
    #         Partially oriented DAG: FairnessAwareHC.base.PDAG
    #             An instance of FairnessAwareHC.base.PDAG.
    #
    #         Examples
    #         --------
    #
    ...
    def do(self, nodes, inplace=False):
        ...
        Returns
        -------
        Modified DAG: FairnessAwareHC.base.DAG
    ...
    def get_ancestral_graph(self, nodes):
        ...
        Returns
        -------
        Ancestral Graph: FairnessAwareHC.base.DAG
...
class PDAG(nx.DiGraph):
    ...
    def copy(self):
        ...
        Returns
        -------
        Copy of PDAG: FairnessAwareHC.dag.PDAG
