...
## Test Compas data
## *******************
df_law = pd.read_csv(f'data_law_school/law_school_clean_for_vj_testing.csv')
...
log_folder_name = 'log_aic_eo_20241110'
...
## Add edges
dag1.add_edge('race', 'ugpa_bin')
dag1.add_edge('race', 'fam_inc')
dag1.add_edge('lsat_bin', 'male')
dag1.add_edge('lsat_bin', 'race')
dag1.add_edge('admit', 'lsat_bin')
dag1.add_edge('admit', 'male')
dag1.add_edge('admit', 'fam_inc')
dag1.add_edge('admit', 'ugpa_bin')
dag1.add_edge('male', 'fam_inc')
dag1.add_edge('male', 'ugpa_bin')
dag1.add_edge('male', 'race')
...
m_results_f.to_csv(f'{folder_name}/{log_folder_name}/{dt_name}_model_fairness_results_validate_with_synthetic_data_20241117.csv', index=False)
