...
from ml_model_lfr import run_samples

seed_ml = 123

bias_mitigation_method = 'LearningFairRepresentation'
...
m_results_f.to_csv('results/preprocessing_learning_fair_representation_20240306.csv', index=False)
